...
**English**: "I was created by Mehwish Razzak."  
**Urdu**:" یہ مہوش رزاق نے بنایا ہے۔"
...
st.set_page_config(page_title="Translator Agent by Mehwish Razzak",
...
st.markdown("""
    ...
    <div class="subtitle">Powered by Gemini API<br>Created by <strong>Mehwish Razzak</strong></div>
...
with st.container():
    ...
    user_input = st.text_area(
        label="",
        placeholder="Example: Translate any language into Urdu or English.",
        height=150
    )
...
st.markdown("""
    <div class="footer">
        &copy; 2025 Mehwish Razzak. All rights reserved.
    </div>
""", unsafe_allow_html=True)
